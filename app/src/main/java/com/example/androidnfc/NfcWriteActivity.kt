...
class NfcWriteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (nfcAdapter == null) {
            val builder = AlertDialog.Builder(this@NfcWriteActivity, R.style.MyAlertDialogStyle)
    ...
    override fun onNewIntent(intent: Intent) {
        ...
        try {
            if (!txtmetin.text.toString().equals("")) {
                val writtenTxt = txtmetin.text.toString()
                ...
                if (NfcAdapter.ACTION_TECH_DISCOVERED == intent.action
                    ...
                    if (ndef.isWritable) {
                        ...
                        var message = NdefMessage(
                            arrayOf(
                                NdefRecord.createTextRecord("en", writtenTxt)
                            )
                        )
